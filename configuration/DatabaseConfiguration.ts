...
export const initDb = async () => {
    ...
    await db.query("CREATE TABLE IF NOT EXISTS livro(uid serial PRIMARY KEY NOT NULL, titulo varchar(255) NOT NULL, autor varchar(255) NOT NULL);");
    await db.query("CREATE TABLE IF NOT EXISTS usuario(uid serial PRIMARY KEY NOT NULL, nome varchar(255) NOT NULL, email varchar(255) NOT NULL, senha varchar(255) NOT NULL);");
